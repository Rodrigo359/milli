...
<body>
<h1>RLZim - PDV <?php echo $this->config->item('application_version'); ?></h1>
<h2>Sistema de compra e venda</h2>
...
<div id="container">
 ...
 <br> <br> <br>
 <center> <h5> <?php $this->load->view("partial/footer"); ?>  </h5> </center>
