...
<div id="overall_sale">
		...
		?>
			<div id="finish_sale">
				...
				<label id="comment_label" for="comment">
					<?php 
						echo "Observações: "; // antigo: $this->lang->line('common_comments')
					?>
				</label>
				<?php 
					// echo form_textarea(array('name'=>'comment', 'id' => 'comment', 'value'=>$comment,'rows'=>'4','cols'=>'23'));
					// Removido o Comment da venda.
				?>
				<br /><br />
				
				<?php
				
				/* if(!empty($customer_email))  // Removido o comando de enviar via e-mail.
				{
    ...
    <table width="100%"><tr>
    <td style="width:55%; "><div class="float_left"><?php echo $this->lang->line('sales_payment_total').': ';?></div></td>
	...
	<td style="width:55%; ">
		<div class="float_right" >  
			<?php   // alterado:
				if ($amount_due < 0) // quando for troco:
				{
					echo "Troco: ";
				}
				else 
	...
	<td style="width:45%; text-align:right; ">
		<div class="float_left" style="text-align:right;font-weight:bold;">
			<?php  // alterado:
				if ($amount_due < 0)  // quando for troco:
				{
					echo to_currency(-$amount_due);  // converter para positivo.
				}
				else 
				{
	...
	<div id="Payment_Types" >
		...
		<div style="height:100px;">
			...
			<tr>
			<td>
				<?php echo $this->lang->line('sales_payment').':   ';  // Pagar com.
				?>  
			</td>
			<td>
				<?php echo form_dropdown( 'payment_type', $payment_options, array(), 'id="payment_types"' );  // lista com as formas de pagamento.
				?>
			</td>
			</tr>
			<tr>
			<td>
				<span id="amount_tendered_label">
					<?php 
						echo $this->lang->line( 'sales_amount_tendered').':  '; // Valor a pagar.
					?>
				</span>
			</td>
			<td>
				<?php 
					if ($amount_due < 0)  // quando for troco, zerar o valror a pagar:
					{
						echo form_input( array( 'name'=>'amount_tendered', 'id'=>'amount_tendered', 'value'=>to_currency_no_money(0), 'size'=>'10' ) );	// converter para positivo.
					}
					else 
					{
						echo form_input( array( 'name'=>'amount_tendered', 'id'=>'amount_tendered', 'value'=>to_currency_no_money($amount_due), 'size'=>'10' ) );	// valor.
