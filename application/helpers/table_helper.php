...
function get_person_data_row($person,$controller)
{
	...
	$table_data_row.='<td width="35%">'.character_limiter($person->first_name,13).'</td>';
	$table_data_row.='<td width="10%">'.character_limiter($person->city,13).'</td>';
	$table_data_row.='<td width="25%">'.mailto($person->email,character_limiter($person->email,22)).'</td>';
